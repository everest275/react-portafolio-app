...
const handleLinkedin=()=>{
  ...
  <div className="container max-w-screen-lg mx-auto">
    <div>
      ...
      <FadeInOut>
      <h2 className="text-3xl font-semibold text-center mb-6 text-gray-700">Social Media</h2>
      </FadeInOut>
      ...
      <div className="flex flex-wrap justify-center gap-2">
        ...
        <button onClick={handleLinkedin} className="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
        ...
        <button onClick={handleGithub}className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
